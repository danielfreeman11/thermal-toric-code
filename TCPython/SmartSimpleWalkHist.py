...
def SingleRun(Dimx,Dimy):
    ...
    xPos,yPos = StartingPositions[random.randint(0,12)]
...
for j in xrange(1):
    ...
    partition = numpy.linspace(0,400000,200001)
    #partition = numpy.linspace(0,100000,50001)    
    thishist = numpy.histogram(nstep,partition)
    numpy.savetxt("SimpleHistograms/SimpleHist_"+str(8*2**j)+"_"+str(sys.argv[1])+"_"+str(sys.argv[2])+".csv",thishist[0],delimiter=",")
    nstep = []
