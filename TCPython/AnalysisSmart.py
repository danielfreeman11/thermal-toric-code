...
#with open('InterpolatedInput.dat','r') as f:
with open('InterpInpLScale2.dat','r') as f:
	for line in f:
		coeffs = line.split("\t")
...
for LargeRun in xrange(1):   
	...
	SubRunI = (parameterindex + SubRun)%len(tempdimtimes)
        ...
        FilNam = "MeasuredRuns11/" + str(Dim) + "_Temp" + str(Temp) + "_Delt" + str(Delt) + "_TransRate" + str(TranRate) + "_" +\
