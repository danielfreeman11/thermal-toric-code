...
\affiliation{Extreme-scale Data Science and Analytics, Sandia National Laboratories, Livermore, CA 94550, USA}
...
\scalebox{1}{\includegraphics[width=1.0\columnwidth]{LifetimeVsSystemsizeJoined.pdf}}
\end{center}
...
\begin{figure}
\begin{center}
\scalebox{1}{\includegraphics[width=1.0\columnwidth]{LifetimeVsTemperatureVsEnergyVsMeasurement.pdf}}
\end{center}
\caption[justification=raggedright]{
...
\scalebox{1}{\includegraphics[width=1.0\columnwidth]{CriticalTempVsMeasurementVsEnergy.pdf}}
\end{center}
...
\begin{figure}
\begin{center}
\scalebox{1}{\includegraphics[width=1.0\columnwidth]{DecodingComparison.pdf}}
\end{center}
